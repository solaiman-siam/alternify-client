    ...
    <div className="max-w-7xl mx-auto">
      <div className="bg-[url('https://i.postimg.cc/P5qXrXRY/topographic-large-grey.webp')]  bg-center bg-cover w-full h-[1200px] lg:h-[650px]">
        <div className="w-full flex-col justify-center flex md:pt-12 pt-8 lg:pt-20">
          ...
          <h2 className="font-semibold lg:text-5xl md:text-4xl text-[26px] text-center ">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 px-14 lg:mt-20 mt-8 md:mt-12">
          <div className="bg-white p-8 rounded-md">
            ...
            <h3 className="lg:text-3xl md:text-3xl text-2xl font-semibold pb-4">
              Recude Illegal Settlements
            </h3>
            <p className="text-slate-500 pr-5">
