  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div>
        ...
        {/* breadcrupbs  */}
        <div className="bg-[#ece6e6b1] h-16 dark:bg-gray-700 px-14 items-center flex justify-start">
          <Link
            to={"/"}
      ...
      <form
        ...
        className="bg-[#F3F4F6] dark:bg-gray-900 py-8"
      >
        <label
      ...
      <div className="flex justify-center dark:bg-gray-900 bg-[#F3F4F6] pt-4 gap-2">
        <button
      ...
      <div
        className={
          column === "one"
            ? "grid lg:grid-cols-1 dark:bg-gray-900 justify-items-center  md:grid-cols-2 grid-cols-1 gap-8 px-14 py-20 bg-gray-100"
            : column === "two"
            ? "grid lg:grid-cols-2 dark:bg-gray-900  md:grid-cols-2 grid-cols-1 gap-8 px-14 py-20 bg-gray-100"
            : "grid lg:grid-cols-3 dark:bg-gray-900  md:grid-cols-2 grid-cols-1 gap-8 px-14 py-20 bg-gray-100"
        }
      >
